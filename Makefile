...
INCLUDES	:= include
INSTALL_HEADER_DIR	:= $(DEVKITPPC)/powerpc-eabi/include
INSTALL_LIB_DIR		:= $(DEVKITPPC)/powerpc-eabi/lib
...
install: $(BUILD)
	...
	@cp -frv $(TARGET) $(INSTALL_LIB_DIR)
	@cp -frv include/*.* $(INSTALL_HEADER_DIR)
